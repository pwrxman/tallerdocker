...
#  para insertar y/o crear un nuevo usuario
@app.post("/userposthe/", response_model=User1, status_code=201)  # Respuest por defecto cuando OK ; Codigo de respuesta por defecto
async def user(user: User1):
    if type(search_user(user.id)) == User1:
